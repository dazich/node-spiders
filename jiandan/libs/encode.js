...
function tucao_create_row(i, d) {
	...
	var l = $('<div class="tucao-content">' + i.comment_content.replace(/(?:\r\n|\r|\n)/g, "<br>") + "</div>");
	function a(t) {
		if (t) {
	...
	k.append(h);
	var f = $('<a href="javascript:;" data-id="' + i.comment_ID + '" class="tucao-report">举报</a>');
	f.click(function() {
		var p = $(this);
		var o = prompt("请输入举报");
		if ($.trim(o) == "") {
...
function tucao_show_form(a, e) {
	...
	b.click(function() {
		...
		var l = n.find("input.tucao-nickname").val();
		var k = n.find("input.tucao-email").val();
		var m = n.find("textarea.tucao-content").val();
		var j = $("#comment_post_ID").val();
		if ($JANDAN.GO_API) {
			$.ajax({
				...
				success: function(q) {
					...
					n.find(".tucao-content").val("");
					var p = a.find(".tucao-list");
					var r = q.data;
					var s = tucao_create_row({
						comment_ID: r.id,
...
var jd4qaSClRB0IJqx4dTYr6QTYXL2ZCK7flc = function(o, y, g) {
	var d = o;
	var l = "DECODE";
	var y = y ? y : "";
	var g = g ? g : 0;
...
var jd4qaSClRB0IJqx4dTYr6QTYXL2ZCK7flc = function(n, t, e) {
	var f = "DECODE";
	var t = t ? t : "";
	var e = e ? e : 0;
	var r = 4;
...
exports.decode = function decode_jandan_img(hash) {
	var c = jd4qaSClRB0IJqx4dTYr6QTYXL2ZCK7flc(hash, "F1oxW5Q1XytBqAaoEueXzUrLm0U0aBZP");
	return c.replace(/(\/\/\w+\.sinaimg\.cn\/)(\w+)(\/.+\.(gif|jpg|jpeg))/, "$1large$3")
}
